...
internal static class PortugueseStrings
{
    public static readonly Dictionary<string, string> All = new()
    {
        ...
        ["CfgGrandezaSearch"]    = "Buscar grandeza...",
        ["CfgGrandezaCounter"]   = "{0} de {1} selecionadas",
        ["CfgCatTensao"]           = "Tensão",
        ["CfgCatCorrente"]         = "Corrente",
        ["CfgCatFrequencia"]       = "Frequência",
        ["CfgCatPotenciaAtiva"]    = "Potência Ativa",
        ["CfgCatPotenciaReativa"]  = "Potência Reativa",
        ["CfgCatPotenciaAparente"] = "Potência Aparente",
        ["CfgCatFatorPotencia"]    = "Fator de Potência",
        ["CfgCatEntradasSaidas"]   = "Entradas e Saídas",
        ["CfgCatHorimetro"]        = "Horímetro",
        ["CfgCatEnergia"]          = "Energias e Demandas",
        ["CfgCatDeltaEnergia"]     = "Delta de Energias",
        ["CfgCatEnergiaPorFase"]   = "Energias por Fase",
        ["CfgCatOutros"]           = "Outros",
