...
internal static class EnglishStrings
{
    public static readonly Dictionary<string, string> All = new()
    {
        ...
        ["CfgGrandezaSearch"]    = "Search measurement...",
        ["CfgGrandezaCounter"]   = "{0} of {1} selected",
        ["CfgCatTensao"]           = "Voltage",
        ["CfgCatCorrente"]         = "Current",
        ["CfgCatFrequencia"]       = "Frequency",
        ["CfgCatPotenciaAtiva"]    = "Active Power",
        ["CfgCatPotenciaReativa"]  = "Reactive Power",
        ["CfgCatPotenciaAparente"] = "Apparent Power",
        ["CfgCatFatorPotencia"]    = "Power Factor",
        ["CfgCatEntradasSaidas"]   = "Inputs and Outputs",
        ["CfgCatHorimetro"]        = "Hour Meter",
        ["CfgCatEnergia"]          = "Energy and Demand",
        ["CfgCatDeltaEnergia"]     = "Delta Energies",
        ["CfgCatEnergiaPorFase"]   = "Energies per Phase",
        ["CfgCatOutros"]           = "Others",
